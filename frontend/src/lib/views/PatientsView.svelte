                      ...
                      <div class="flex flex-wrap items-center gap-1.5 sm:gap-2 p-2 sm:p-3 rounded-lg {reminder.completed ? 'bg-slate-50' : 'bg-amber-50'}">
                        ...
                        <div class="flex items-center gap-0.5 sm:gap-1">
                          ...
                          <button
                            ...
                            class="p-1 sm:p-1.5 text-green-600 hover:text-green-700 hover:bg-green-50 rounded transition-colors duration-200 {reminder.delivery_status === 'sending' ? 'opacity-50 cursor-not-allowed' : ''}"
                            aria-label={$t('reminder.send.button')}
                            disabled={reminder.delivery_status === 'sending'}
                            title={$t('reminder.send.title')}
                          >
