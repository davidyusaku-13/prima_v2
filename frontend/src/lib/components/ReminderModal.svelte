...
{#if show}
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    ></div>
    <div
      class="relative bg-white rounded-xl sm:rounded-2xl shadow-xl w-full max-w-md p-4 sm:p-6 max-h-[90vh] overflow-y-auto"
    ...
    >
      ...
      <form onsubmit={handleSubmit} class="space-y-4">
        ...
        <div>
          <label for="dueDate" class="block text-sm font-medium text-slate-700 mb-1">
            {$t('reminders.dueDate')}
          </label>
          <input
            id="dueDate"
        ...
        <div class="pt-4 border-t border-slate-100">
          ...
          <div class="space-y-3">
            <div>
              <label for="frequency" class="block text-xs text-slate-500 mb-1">
                {$t('reminders.repeat')}
              </label>
              <select
                id="frequency"
            ...
            {#if reminderForm.recurrence.frequency !== 'none'}
              <div>
                <label for="interval" class="block text-xs text-slate-500 mb-1">
              ...
              <div>
                <label for="endDate" class="block text-xs text-slate-500 mb-1">
                  {$t('reminders.endDate')}
                </label>
                <input
                  id="endDate"
