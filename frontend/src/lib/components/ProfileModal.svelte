...
{#if show}
  <div
    class="fixed inset-0 z-50 flex items-end lg:items-center justify-center lg:p-4"
  >
    <div
      ...
      <div class="border-t border-slate-100 pt-4">
        ...
        <div class="flex gap-2">
          <button
            ...
            class="flex-1 h-10 py-2.5 rounded-xl font-medium transition-colors duration-200 flex items-center justify-center {locale ===
            'en'
