    ...
    >
      <span id="preview-description" class="sr-only">
        {#if contentType === "article"}
          Pratinjau artikel dengan gambar, judul, kutipan, dan informasi
          penulis.
        {:else}
          Pratinjau video dengan thumbnail, judul, durasi, dan informasi
          channel.
        {/if}
      ...
      {#if contentType === "article"}
        <div class="flex flex-col">
          ...
          <div class="p-5">
            <span
              class="inline-block px-2 py-1 bg-teal-50 text-teal-700 text-xs font-medium rounded-lg mb-3"
            >
            ...
            <h2
              id="preview-title"
              class="text-lg font-semibold text-slate-900 mb-2 pr-8"
            >
              {content.title}
            </h2>
            ...
            <div class="flex flex-wrap gap-3 text-xs text-slate-500 mb-3">
              {#if content.authorName}
                <span
                  ...
                  aria-label={$t("content.attribution.author")}
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
              ...
              {#if formattedDate}
                <span
                  class="flex items-center gap-1"
                  aria-label={$t("content.attribution.publishedOn")}
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
      ...
      {:else if contentType === "video"}
        <div class="flex flex-col">
          ...
          <div class="w-full h-48 bg-slate-100 relative overflow-hidden">
            ...
            {#if content.duration}
              <div
                class="absolute bottom-2 right-2 z-10 px-2 py-0.5 bg-black/80 text-white text-xs rounded"
              >
                {content.duration}
              </div>
            {/if}
            ...
            >
              ...
              >
                <svg
                  class="w-6 h-6 text-teal-600 ml-1"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
          ...
          <div class="p-5">
            <span
              class="inline-block px-2 py-1 bg-purple-50 text-purple-700 text-xs font-medium rounded-lg mb-3"
            >
            ...
            <div class="flex flex-wrap gap-3 text-xs text-slate-500 mb-3">
              ...
              {#if formattedDate}
                <span
                  class="flex items-center gap-1"
                  aria-label={$t("content.attribution.uploadedOn")}
                >
                  <svg
                    class="w-4 h-4"
                    fill="none"
